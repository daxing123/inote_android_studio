...
public class ServiceBuilder {
    ...
    /**
     * Configures the OAuth access type. This is only necessary in some APIs
     * (like Google's).
     * 
     * @param accessType
    ...
    /**
     * Configures if the user should be re-prompted for consent. This is only
     * necessary in some APIs (like Google's).
     * 
    ...
    public OAuthService build() {
        ...
        return api.createService(new OAuthConfig(apiKey, apiSecret, callback, signatureType, scope,
                grantType, accessType, approvalPrompt, debugStream));
    }
}
