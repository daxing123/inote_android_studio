...
public abstract class Folder {
    ...
    /**
     * Forces an open of the MailProvider. If the provider is already open this function returns without doing anything.
     * 
     * @param mode
    ...
    /**
     * Forces a close of the MailProvider. Any further access will attempt to reopen the MailProvider.
     */
    ...
    /**
     * Get the mode the folder was opened with. This may be different than the mode the open was requested with.
     * 
     * @return
     */
    ...
    /**
     * Create a new folder with a specified display limit. Not abstract to allow remote folders to not override or worry
     * about this call if they don't care to.
     */
    ...
    /**
     * Fetches the given list of messages. The specified listener is notified as each fetch completes. Messages are
     * downloaded as (as) lightweight (as possible) objects to be filled in with later requests. In most cases this
    ...
    public abstract Message[] getMessages(String[] uids, MessageRetrievalListener listener) throws MessagingException;

    public abstract void appendMessages(Message[] messages, AppendMessagesListener listener) throws MessagingException;

    public abstract void appendMessages(long startedTime, Message[] messages, AppendMessagesListener listener)
            throws MessagingException;
    ...
    public abstract void setFlags(Message[] messages, Flag[] flags, boolean value) throws MessagingException;
    ...
    public abstract String[] getLabelsByUid(String uid) throws MessagingException;

    public void expunge() throws MessagingException {
    }

    public abstract void fetch(Message[] messages, FetchProfile fp, MessageRetrievalListener listener)
            throws MessagingException;

    public abstract int fetchMessageSize(Message message) throws MessagingException;

    public abstract void fetchFilterLarge(Message[] messages, FetchProfile fp, long maxSize,
